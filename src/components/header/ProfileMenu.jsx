...
export default function ProfileMenu() {
  ...
  return (
    ...
    >
      ...
      {/* Dropdown */}
      <div
        className={`absolute right-0 mt-3 w-72 bg-white border border-gray-100 rounded-xl shadow-xl p-5 z-50 
      ...
      >
        ...
        {isAuthenticated && (
          <button
            onClick={logout}
            className="w-full mt-3 flex items-center justify-center gap-2 py-2 text-sm 
            bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition"
          >
