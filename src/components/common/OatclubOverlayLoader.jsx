...
export default function OatclubOverlayLoader({
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative h-[86px] w-[86px] animate-[oatclub-flash_1.05s_ease-in-out_infinite] sm:h-[104px] sm:w-[104px]">
          <Image
            src={BRAND_IMAGE}
            alt="OATCLUB"
            fill
        ...
        <div className="mt-5 flex items-center gap-3">
          <span className="h-px w-8 bg-black/18" />
          <span className="text-[9px] font-black uppercase tracking-[0.28em] text-black/45">
            {label}
          </span>
          <span className="h-px w-8 bg-black/18" />
        </div>

        <p className="mt-3 text-[9px] font-black uppercase tracking-[0.2em] text-black/25">
          OWN ALL TRENDS
        </p>
      </div>
