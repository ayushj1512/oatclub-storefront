...
export default function CategoryMosaic() {
  ...
  return (
    <section className="w-full bg-white px-3 pt-8 pb-5 text-black md:px-8 md:pt-12 md:pb-8">
      <div className="w-full">
        <div className="mb-5 flex justify-center">
          <h2 className="text-center text-2xl font-black uppercase leading-tight text-black md:text-4xl">
            Shop by Category
          </h2>
        </div>
