  ...
  useEffect(() => {
    ...
    const loadProducts = async () => {
      try {
        ...
        // ✅ fetch ONLY from winter-drops category
    ...
    <section className="w-full bg-white">
      <div className="w-full px-4 md:px-8 py-8 md:py-10">
        ...
        <div className="flex items-end justify-between gap-4 mb-5 md:mb-6">
          <div>
            <p className="text-xs font-semibold text-gray-500 tracking-[0.22em] uppercase">New Arrival</p>

            <h2 className="text-xl md:text-3xl font-extrabold text-black tracking-tight">Winter Drops</h2>
          ...
          <Link href="/winterdrops" className="hidden md:inline-flex text-sm font-semibold text-black hover:opacity-60 transition">
            View All →
          </Link>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-start justify-start gap-6 md:gap-6">
          ...
          <Link href="/winterdrops" className="block w-full md:w-[40%] lg:w-[38%] flex-none self-start">
            <div className="relative w-full overflow-hidden aspect-[4/4] md:aspect-square rounded-2xl border border-gray-200 bg-gray-100">
              {localLoading && <ShimmerBlock className="absolute inset-0 rounded-2xl" />}
          ...
          <div className="w-full md:flex-1 min-w-0">
            ...
            <div className="md:hidden">
              <div className="flex items-center justify-between mb-3 mt-4">
                ...
                <Link href="/winterdrops" className="text-xs font-semibold text-black hover:opacity-60 transition">
                  View all →
                </Link>
              </div>
