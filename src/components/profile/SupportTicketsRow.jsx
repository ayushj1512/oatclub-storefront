...
return (
  <div className="bg-white border border-black/10 rounded-xl">
    ...
    <div className="px-5 py-4 border-b border-black/10 flex flex-wrap gap-3 items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          disabled={!canLoad}
          className={cx(
            "inline-flex items-center gap-2 px-3 py-2 text-xs font-semibold border rounded-md transition",
            canLoad
        ...
        <Link
          href={newTicketHref}
          className="inline-flex items-center gap-2 px-3 py-2 text-xs font-semibold border border-black/10 rounded-md hover:bg-black/5 transition"
        >
    ...
    <div className="px-5 py-4">
      ...
      {/* Error */}
      {error && (
        <div className="mb-3 p-3 text-xs border border-black/10 bg-black/5 flex gap-2">
          ...
          {visibleTickets.map((t) => {
            ...
            return (
              <button
                key={id}
                onClick={() => goTicket(id)}
                className="w-full border border-black/10 rounded-lg hover:bg-black/5 transition text-left"
              >
