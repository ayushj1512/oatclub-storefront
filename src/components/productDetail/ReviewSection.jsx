        ...
        <div className="mx-auto flex max-w-3xl items-center justify-center gap-2 overflow-x-auto">
          {photos.map((photo, index) => (
            <button
              ...
              className={`relative h-14 w-11 shrink-0 overflow-hidden border ${index === active ? "border-black" : "border-black/10"
                }`}
            >
...
export default function ReviewSection({ productCode = "" }) {
  ...
  return (
    <section className="bg-white px-4 md:px-6 py-8 text-black md:py-10">      <div className="border-t border-black/10 pt-5">
